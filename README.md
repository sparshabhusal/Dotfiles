...
<h3 align=center>
<img width="450" src="https://github.com/user-attachments/assets/8cf50b33-107b-45e1-b797-d9b1f8d81353" />
</h3>
...
The update script is in developement.                          
To update the dotfiles , you can just run the install script again : 
```
git clone https://github.com/spasrhabhusal/Dotfiles.git
cd Dotfiles
./install.sh
